        ...
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="{{ route('admin.dashboard') }}">
                        Dashboard</a></div>
                <div class="breadcrumb-item active"><a href="{{ route('admin.history') }}">
                        History Pembelian</a></div>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input id="nama_produk" type="text" class="form-control" value="{{ $data->nama_produk }}"
                                readonly>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input id="category" type="text" class="form-control" value="{{ $data->category }}"
                                readonly>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input id="total_harga" type="text" class="form-control" value="{{ $data->total_harga }}"
                                readonly>
                        </div>
                    </div>
                </div>
