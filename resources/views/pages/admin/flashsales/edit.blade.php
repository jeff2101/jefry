...
<div class="main-content">
    <section class="section">
        ...
        <div class="card mt-4">
            <form action="{{ route('flashsales.update', $flash_sales->id) }}" class="needs-validation" novalidate=""
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="product_id" required="">
                                    @foreach ($products as $product)
                                        <option value="{{ $product->id }}" {{ $flash_sales->product_id == $product->id ? 'selected' : '' }}>
                                            {{ $product->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input id="discount_price" type="number" class="form-control" name="discount_price"
                                    required="" value="{{ $flash_sales->discount_price }}">
                                <div class="invalid-feedback">
                                    Kolom ini harus di isi!
                                </div>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input id="start_time" type="datetime-local" class="form-control" name="start_time"
                                    required=""
                                    value="{{ Carbon\Carbon::parse($flash_sales->start_time)->format('Y-m-d\TH:i:s') }}">
                                <div class="invalid-feedback">
                                    Kolom ini harus di isi!
                                </div>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input id="end_time" type="datetime-local" class="form-control" name="end_time"
                                    required=""
                                    value="{{ Carbon\Carbon::parse($flash_sales->end_time)->format('Y-m-d\TH:i:s') }}">
                                <div class="invalid-feedback">
                                    Kolom ini harus di isi!
                                </div>
                            </div>
